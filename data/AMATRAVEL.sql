...
CREATE TABLE `pessoa` (
  ...
  `valor_ida` float(3,2) DEFAULT NULL,
  `valor_volta` float(3,2) DEFAULT NULL,
...
CREATE TABLE `viagens` (
  ...
  CONSTRAINT `viagens_ibfk_1` FOREIGN KEY (`pessoa_id`) REFERENCES `pessoa` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-27 13:12:24
